...
RedisDatastore = class RedisDatastore {
  ...
  onMessage(channel, message) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (type === "capacity") {
        yield _this2.instance._drainAll(data.length > 0 ? ~~data : void 0);

        if (channel === _this2.instance.channel_client()) {
  ...
  runScript(name, args) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return new _this3.Promise((resolve, reject) => {
        ...
        _this3.instance.Events.trigger("debug", [`Calling Redis script: ${name}.lua`, args_ts]);
        ...
        return _this3.connection.__scriptFn__(name).apply({}, arr);
      }).catch(e => {
