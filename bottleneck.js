...
},{"../package.json":14,"./BottleneckError":2,"./DLList":3,"./Events":4,"./Group":5,"./Local":6,"./RedisStorage":7,"./States":9,"./Sync":10,"./parser":13}],2:[function(require,module,exports){
"use strict";
...
},{"./Bottleneck":1,"./Events":4,"./parser":13}],6:[function(require,module,exports){
"use strict";
...
},{"./BottleneckError":2,"./DLList":3,"./parser":13}],7:[function(require,module,exports){
"use strict";
...
// Generated by CoffeeScript 2.2.4
(function () {
  var BottleneckError, DLList, RedisConnection, RedisStorage, Scripts, parser;
  ...
  RedisConnection = class RedisConnection {
    ...
    removeLimiter(instance) {
      return delete this.pubsubs[instance.id];
    }
  ...
  RedisStorage = class RedisStorage {
    constructor(instance1, initSettings, options) {
      ...
      this.shas = {};
      this.isReady = false;
      this.connection = new RedisConnection(this.clientOptions, this.Promise, this.instance.Events);
...
},{"./BottleneckError":2,"./DLList":3,"./Scripts":8,"./parser":13}],8:[function(require,module,exports){
"use strict";
...
},{"./lua.json":12}],9:[function(require,module,exports){
"use strict";
...
},{"./BottleneckError":2}],10:[function(require,module,exports){
"use strict";
...
},{"./DLList":3}],11:[function(require,module,exports){
"use strict";
...
},{"./Bottleneck":1}],12:[function(require,module,exports){
module.exports={
