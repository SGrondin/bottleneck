    ...
    class Bottleneck {
      constructor(options = {}, ...invalid) {
        ...
        this._store = function () {
          ...
          } else if (this.datastore === "ioredis") {
            return new IORedisStorage(this, sDefaults, parser.load(options, this.storeInstanceDefaults, {}));
          } else {
...
},{"../package.json":17,"./BottleneckError":2,"./DLList":3,"./Events":4,"./Group":5,"./IORedisStorage":7,"./Local":8,"./RedisStorage":10,"./States":12,"./Sync":13,"./parser":16}],2:[function(require,module,exports){
"use strict";
...
// Generated by CoffeeScript 2.2.4
(function () {
  var BottleneckError, IORedisConnection, IORedisStorage, Scripts, parser;
  ...
  IORedisStorage = class IORedisStorage {
    constructor(instance, initSettings, options) {
      ...
      this.isReady = false;
      this.connection = (ref = this._groupConnection) != null ? ref : new IORedisConnection(this.clientOptions, this.Promise, this.instance.Events);
      this.ready = this.connection.ready.then(clients => {
        this.clients = clients;
        return this._loadAllScripts();
      }).then(() => {
        var args;
    ...
    _loadAllScripts() {
      if (this.connection.loaded) {
        ...
        return Scripts.names.forEach(name => {
          this.connection.client.defineCommand(name, {
    ...
    runScript(name, args) {
      ...
      if (!this.isReady) {
        ...
        return new this.Promise((resolve, reject) => {
          var arr;
          arr = [keys.length].concat(keys, args, function (err, replies) {
            if (err != null) {
              return reject(err);
            }
          ...
          return this.clients.client[name].bind(this.clients.client).apply({}, arr);
        }).catch(e => {
...
},{"./BottleneckError":2,"./IORedisConnection":6,"./Scripts":11,"./parser":16}],8:[function(require,module,exports){
"use strict";
...
},{"./BottleneckError":2,"./DLList":3,"./parser":16}],9:[function(require,module,exports){
"use strict";
...
},{"./BottleneckError":2,"./RedisConnection":9,"./Scripts":11,"./parser":16}],11:[function(require,module,exports){
"use strict";
