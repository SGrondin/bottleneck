...
// Generated by CoffeeScript 2.2.2
(function () {
  var BottleneckError, Events, Group, parser;
    ...
    class Group {
      constructor(limiterOptions = {}, groupOptions = {}) {
        ...
        if (this.limiterOptions.datastore === "redis") {
          throw new BottleneckError("Groups do not currently support Clustering. This will be implemented in a future version. Please open an issue at https://github.com/SGrondin/bottleneck/issues if you would like this feature to be implemented.");
        }
      ...
      key(key = "") {
        ...
        return (ref = this.instances[key]) != null ? ref : (() => {
          var limiter;
          limiter = this.instances[key] = new this.Bottleneck(this.limiterOptions);
...
},{"./Bottleneck":1,"./BottleneckError":2,"./Events":4,"./parser":11}],6:[function(require,module,exports){
"use strict";
